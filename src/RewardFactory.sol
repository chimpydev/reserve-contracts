...
contract Vault is SemiFungibleVault, ReentrancyGuard {
    ...
    /**
        ...
        @param  _name   token name for the ERC1155 mints. Insert the name of your token; Example: RSVI_USDC_1.2$
        @param  _symbol token symbol for the ERC1155 mints. insert here if risk or hedge + Symbol. Example: HedgeRSVI or riskRSVI;
...
contract VaultFactory is Ownable {
    ...
    function createNewMarket(
        ...
        //rsviUSDC_99*RISK or rsviUSDC_99*HEDGE
